...
<CardGroup cols={2}>
  <Card title="函数设计原则" icon={<svg style={{maskImage: "url(/resource/icon/code.svg)", WebkitMaskImage: "url(/resource/icon/code.svg)",
...
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"} />}>
  ...
  <Card title="安全考虑" icon={<svg style={{maskImage: "url(/resource/icon/shield.svg)", WebkitMaskImage: "url(/resource/icon/shield.svg)",
maskRepeat: "no–repeat",
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"} />}>
    *输入验证：严格验证所有输入参数
    * 权限控制：限制函数的访问权限
