...
<Tip>
  本指南将帮助您快速上手 [GLM Coding Plan](https://zhipuaishengchan.datasink.sensorsdata.cn/t/Gd)，从订阅套餐到在编码工具中使用 GLM-4.7 模型，只需几分钟即可完成。
</Tip>
...
<Steps>
  ...
  <Step title="配置编码工具">
    以 Claude Code 为例，配置 GLM-4.7 模型：
