...
> 若您的 Kilo Code 版本较低没有 `China Coding` 选项，请先将插件更新到最新版本。

* **API Provider**：选择 `Z AI`
* **Z AI Entrypoint**：选择 `China Coding (https://open.bigmodel.cn/api/coding/paas/v4)`
...
参考 [视觉MCP服务器](/cn/coding-plan/mcp/vision-mcp-server) ，[搜索MCP服务器](/cn/coding-plan/mcp/search-mcp-server) 和 [网页读取MCP服务器](/cn/coding-plan/mcp/reader-mcp-server) 文档，配置完成后即可在 Kilo 中使用。
