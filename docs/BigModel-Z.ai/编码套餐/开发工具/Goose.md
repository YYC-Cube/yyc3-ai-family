...
参考 [视觉MCP服务器](/cn/coding-plan/mcp/vision-mcp-server) ，[搜索MCP服务器](/cn/coding-plan/mcp/search-mcp-server) 和 [网页读取MCP服务器](/cn/coding-plan/mcp/reader-mcp-server) 文档，配置完成后即可在 Goose 中使用。
