import { Activity, Server, Database, Zap, Wifi, Lock, TrendingUp, AlertCircle, Fingerprint } from 'lucide-react';
...
export function ServiceHealthMonitor() {
  ...
  return (
    <div className="flex-1 w-full bg-[#050505] text-foreground font-mono p-3 md:p-6 overflow-hidden flex flex-col relative animate-in fade-in duration-500">
      <div className="absolute inset-0 pointer-events-none bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.1)_50%),linear-gradient(90deg,rgba(255,0,0,0.03),rgba(0,255,0,0.01),rgba(0,0,255,0.03))] z-[5] bg-[length:100%_2px,3px_100%]" />
    ...
    <div className={cn(
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex gap-1">
          <div className={cn('w-1.5 h-1.5 rounded-full animate-pulse', textColor ? textColor.replace('text-', 'bg-') : 'bg-green-500')} />
        </div>
      </div>
