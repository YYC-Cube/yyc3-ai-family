    ...
    return (
      <>
        ...
        <div className="fixed top-0 left-0 right-0 h-12 bg-black/90 backdrop-blur-md border-b border-white/5 flex items-center px-3 gap-3 z-40">
          ...
          <div className="w-6 h-6 rounded bg-primary/20 flex items-center justify-center border border-primary/50 text-primary font-mono text-[10px]">
            Y3
          </div>
          <span className="font-mono text-xs text-primary tracking-wider">YYC3</span>
...
function SidebarContent({
  ...
  isExpanded, pinned, onTogglePin, onClose, t
}: SidebarContentProps) {
  return (
    <div className={cn(
      ...
      <div className="p-3 border-b border-border flex items-center gap-2 shrink-0">
        <div className="w-8 h-8 rounded bg-primary/20 flex items-center justify-center border border-primary/50 text-primary font-mono text-xs shrink-0 shadow-[0_0_10px_rgba(14,165,233,0.3)]">
          Y3
        </div>
        {isExpanded && (
          <div className="flex-1 min-w-0 animate-in fade-in duration-150">
            <h1 className="font-mono text-sm tracking-wider text-primary glow-text truncate">YYC3_DEVOPS</h1>
            <p className="text-[10px] text-muted-foreground font-mono">v3.0.1-beta</p>
          </div>
        )}
        {isExpanded && onClose && (
