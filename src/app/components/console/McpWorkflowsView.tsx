...
export function McpWorkflowsView() {
  ...
  const handleApplyToProject = () => {
    ...
    // Simulate applying template to project
    setApplySuccess(true);
    addLog('success', 'DEVOPS', `Applied template "${selected.name}" to project "${applyTarget}"`);
    setTimeout(() => {
          ...
          <div className="w-full max-w-md bg-zinc-900 border border-primary/20 rounded-xl shadow-2xl p-6 animate-in zoom-in-95 duration-200 mx-4">
            {applySuccess ? (
              <div className="text-center py-6 animate-in zoom-in-95 duration-300">
                ...
                <h3 className="text-sm font-mono text-green-400 mb-1">TEMPLATE_APPLIED</h3>
