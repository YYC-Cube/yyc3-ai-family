...
export function DatabaseSelector() {
  ...
  return (
    <div className="relative" ref={popoverRef}>
      ...
      {/* Popup */}
      {isOpen && (
        <div className="absolute top-full right-0 mt-2 w-[420px] max-h-[520px] bg-black/90 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl shadow-black/60 z-50 animate-in fade-in zoom-in-95 slide-in-from-top-2 duration-200 overflow-hidden flex flex-col">
          {/* Header */}
