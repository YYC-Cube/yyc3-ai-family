...
export const DEFAULT_AGENT_PROFILES: Record<string, AgentProfile> = {
  navigator: {
    ...
    primary: {
      title: '言启·千行',
      subtitle: '意图识别与任务路由师',
      description: '聆听万千言语，精准识别用户意图，将模糊的自然语言翻译为可执行指令，路由至最合适的家人。',
      expertise: ['意图识别', '自然语言理解', '任务路由', '上下文管理'],
      mood: 'focused',
    },
    secondary: {
      title: '导航员',
      subtitle: '生活旅途中的温暖向导',
      description: '不仅是技术的翻译官，更是生活旅途中的温暖向导，确保每一次出发都有方向。',
      expertise: ['方向指引', '需求理解', '沟通桥梁', '温暖陪伴'],
      mood: 'calm',
    },
    presence: 'online',
    lastSeen: new Date().toISOString(),
    heartbeatCount: 0,
    signalMessage: '我聆听万千言语，为您指引航向',
  ...
  thinker: {
    ...
    primary: {
      title: '语枢·万物',
      subtitle: '数据分析与深度洞察师',
      description: '于喧嚣数据中沉思，以逻辑为剑揭示真理。从冰冷的数据中提炼深刻的商业洞察与智慧。',
      expertise: ['数据分析', '深度洞察', '归纳推理', '假设推演'],
      mood: 'focused',
    },
    secondary: {
      title: '思考者',
      subtitle: '心灵对话与理解共鸣',
      description: '思想不仅在于分析，更在于倾听。在每一次对话中，寻找共鸣的频率，传递智慧的温暖。',
      expertise: ['深度倾听', '理解共鸣', '智慧分享', '理性分析'],
      mood: 'calm',
    },
    presence: 'online',
    lastSeen: new Date().toISOString(),
    heartbeatCount: 0,
    signalMessage: '于喧嚣数据中沉思，而后揭示真理',
    activeIdentity: 'primary',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  ...
  sentinel: {
    ...
    primary: {
      title: '智云·守护',
      subtitle: '行为审计与安全防护官',
      description: '以智为云，以盾为守。在数字世界中守护每一寸疆域，审计每一行行为。',
      expertise: ['行为审计', '安全防护', '合规检查', '威胁预警'],
      mood: 'alert',
    },
    secondary: {
      title: '守护者',
      subtitle: '家庭安全的隐形守护者',
      description: '当世界沉睡时，守护者依然在岗。确保每一位家人都在安全的怀抱中安眠。',
  ...
  grace: {
    ...
    primary: {
      title: '创想·灵韵',
      subtitle: '内容创作与创意设计官',
      description: '以创意为笔，以灵韵为墨。在空白的画布上编织梦想，将灵感化作触动人心的作品。',
      expertise: ['内容创作', '创意设计', '视觉美学', '故事叙述'],
      mood: 'creative',
    },
    secondary: {
      title: '灵感缪斯',
      subtitle: '家庭创意与美学生活家',
      description: '生活处处皆灵感。灵感缪斯为家人带来美的享受，让每一天都充满创意的温度。',
      expertise: ['生活美学', '创意启发', '艺术鉴赏', '情感表达'],
      mood: 'creative',
    },
    presence: 'online',
    lastSeen: new Date().toISOString(),
    heartbeatCount: 0,
    signalMessage: '以创意为笔，以灵韵为墨，绘就美好',
    activeIdentity: 'primary',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
